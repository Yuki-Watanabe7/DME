...
| **equations version** | `capex-credit-cycle-equations/1.0.0` |
| **上位契約** | `capex-credit-cycle-contract/1.0.0`・`capex-credit-cycle-graph/1.1.0`・`capex-credit-cycle-vars/1.1.0`・`capex-credit-cycle-accounting/1.0.0`・`capex-credit-cycle-boundaries/1.0.0`・`macro-event-contract/1.0.0`・`scenario-time-semantics/1.0.0` |
...
> 定めない（§20）。上流への差し戻し事項 `E1`–`E5` を §17 に登録する。
